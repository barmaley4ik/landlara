            ...
            <div class="row">
                <div class="col-md-8">
                    ...
                    <div class="panel panel panel-bordered">
                        <div class="panel-body">
                            @php
                            $fieldrow = array('title','subtitle','description');
                            @endphp                     
                            @foreach($dataTypeRows as $row)
                                @if (in_array($row->field, $fieldrow))
                                    @php
                ...
                <div class="col-md-4">
                    ...
                    <div class="panel panel panel-bordered">
                        <div class="panel-body">
                            @php
                            $fieldrow = array('blockvideo_belongstomany_onevideo_relationship','blockvideo_hasone_menu_item_relationship');
                            @endphp                     
                            @foreach($dataTypeRows as $row)
                                @if (in_array($row->field, $fieldrow))
                                    @php
