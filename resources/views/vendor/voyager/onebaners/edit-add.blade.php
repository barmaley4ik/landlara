...
@section('content')
    ...
    <div class="page-content container-fluid">
        <form class="form-edit-add" role="form" action="@if(isset($dataTypeContent->id)){{ route('voyager.onebaners.update', $dataTypeContent->id) }}@else{{ route('voyager.onebaners.store') }}@endif" method="POST" enctype="multipart/form-data">
            ...
            <div class="row">
                <div class="col-md-8">
                    <div class="panel panel panel-bordered">
                        <div class="panel-body">
                            @php
                            $fieldrow = array('name', 'text', 'css_custom');
                            @endphp                     
                ...
                <div class="col-md-4">
                    <div class="panel panel panel-bordered panel-warning">
                        <div class="panel-body">
                            @php
                            $fieldrow = array('url', 'sort_order', 'css_custom');
                            @endphp                     
                            @foreach($dataTypeRows as $row)
                                @if (in_array($row->field, $fieldrow))
                                    @php
                    ...
                    <div class="panel panel panel-bordered panel-warning">
                        ...
                        <div class="panel-body">
                            @php
                            $fieldrow = array('image', 'title_image', 'alt_image');
                            @endphp                     
                            @foreach($dataTypeRows as $row)
                                @if (in_array($row->field, $fieldrow))
                                    @php
                    ...
                    <div class="panel panel panel-bordered panel-warning">
                        ...
                        <div class="panel-body">
                            @php
                            $fieldrow = array('button', 'caption_button');
                            @endphp                     
                            @foreach($dataTypeRows as $row)
                                @if (in_array($row->field, $fieldrow))
                                    @php
